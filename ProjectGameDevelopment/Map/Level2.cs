...
{
    public class Level2 : GameScreen, ILevelDesigner
    {
        ...
        public LoadCollisions _desiredLevel = new LoadCollisions();
        ...
        public override void LoadContent()
        {
            ...
            _collisionTiles = _desiredLevel.GetCollisionTiles(_map, _collisionTiles);

            _enemyPathway = _desiredLevel.GetEnemyPathWay(_map, _enemyPathway);

            _respawnZone = _desiredLevel.GetRespawnZone(_map, _respawnZone);
